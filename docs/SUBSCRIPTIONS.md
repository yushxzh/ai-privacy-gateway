...
> 本文保留 2026-09-11 至 0.1.4 阶段的调研快照，未在本次文档整理中重新核验厂商政策。0.1.6 已完成 WorkBuddy 原登录文本过滤与 macOS 一键接入；当前项目状态见 [全局 PRD](PRD.md#客户端计划)，使用步骤见 [指南](USAGE.md)。下文「内置模型未过滤」等结论属于当时状态。
